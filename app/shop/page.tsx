...
export default async function ShopPage() {
  ...
  return (
    <>
      <section className="border-b border-border/70 bg-[radial-gradient(circle_at_top_right,rgba(90,98,15,0.15),transparent_30%),linear-gradient(180deg,rgba(26,21,19,0.95),rgba(11,10,11,0.96))] py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <p className="text-xs uppercase tracking-[0.28em] text-yisos-gold">Private Collection</p>
          <h1 className="mt-3 max-w-4xl font-display text-5xl text-yisos-stitch md:text-6xl">The Collection For Tonight&apos;s Ritual</h1>
          <p className="mt-4 max-w-2xl text-yisos-bone/78">
